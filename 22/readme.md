...
What I did was take the entire list of names and split it into an array in ruby. I then stepped through the array and created a value from each name using an array of the alphabet and the index method to change A into 1 and B into 2 and so on.